...
CREATE TABLE [UserProfiles] (
    ...
    [Address_StreetName] nvarchar(max) NOT NULL,
    [Address_HouseNumber] int NOT NULL,
    [Address_HouseNumberSuffix] nvarchar(max) NULL,
    [Address_PostalCode] nvarchar(max) NOT NULL,
    [Address_CountryCode] nvarchar(max) NOT NULL,
...
VALUES (N'20240308101131_InitialIdentity', N'8.0.2');
GO
